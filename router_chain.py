...
response=chain.invoke({"input":"What is Computer Science"})
# response=chain.invoke({"input":"I need to go to Kenya for vaction, a family of four, Can you help me plan this trip?"})
print(response)